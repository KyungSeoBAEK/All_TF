...
<body data-spy="scroll" data-target="#navbarResponsive">
							...
							<div class="goods_form">
								<header class="goods_header" style="margin-top : 0px;">
									<div class="view-tit" style="font-size: 22px !important;">
										Bouquet Optic Vase - Clear																	
									</div>
									<div class="i-pay i-width"">
										KRW 18,000															
									</div>
								</header>
								<div class="i-font-70" style="margin-bottom: 24px; font-size: 12px;">
									<div class="i-fr">
										<p>This basket is from danish brand, Ferm Living.</p>
										<p><br></p>
										<p>Bringing the traditional basket weaving technique to pottery, </p>
										<p>Our handmade Braided Baskets recreate the familiar feel of woven </p>
										<p>containers. This multifunctional design can be put to use as a plant pot, </p>
										<p>Fruit bowl or decorative focal point in a room. Each piece is unique.</p>
										<p><br></p>
								...
								<div class="i-detail" style="font-size: 14px;">
									<div class="i-margin-b">
										<div class="" style="display: block;">
											<div class="inline-blocked vertical-middle" style="font-size: 10px!important;">
										...
										<div class="" style="display: block;">
											<div class="inline-blocked vertical-middle" style="font-size: 10px!important;">
												<span">Shipping fee KRW 2,500 (Free shipping over KRW 50,000)</span>
											</div>
										</div>
										<div class="" style="display: block;">
											<div class="inline-blocked vertical-middle" style="font-size: 10px!important;">
								...
								<div>
									<div class="i-block i-border" style="height: auto;">
										<div class="area_tit holder" style="">
										</div>
									</div>
								</div>
								
								<div class="goods_payment">
									<p class="i-block-bottom no-margin" style="text-align: right; margin: 0 !important;">
										<span class="i-total i-font-70" style="padding: 16px 0; text-align: left; font-size:14px;">Subtotal (1)</span>
										<span class="i-total total_price" style="padding: 16px 0">KRW 31,000</span>
									</p>
								</div>
								
								<div class="holder buy-btns">
									<a class="btn1 btn-w1 bg-brand" style=" margin-left: 0;" onclick="">Buy Now</a>
									<a class="btn1 btn-w2">Add to cart</a>
									<a class="btn1 btn-w2" style="margin-right: 0 !important; font-family: Arial;">¢½ 3</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="categorize review-box" style="">
						<div class="fr-view">
							<div class="button_tab">
								<div class="nav_wrap" style="z-index: auto; position: static; top: auto;">
									<ul class="site_prod_nav">
										<li class="i-li i-child i-bc table-cell holder" style="width: 33.33%; float: left; border-radius: 0;">
											<a class="i-b1" href="#prod-detail" style="margin-left: 0;">Details</a>
										</li>
										<li class="i-li i-child i-bc table-cell holder" style="width: 33.33%; float: left; border-radius: 0;">
											<a class="i-b1" href="#prod-reviews" style="margin-left: 0;">Reviews</a>
										</li>
										<li class="i-li i-child i-bc table-cell holder" style="width: 33.33%; float: left; border-radius: 0;">
											<a class="i-b1" href="#prod-qna" style="margin-left: 0;">Q&A</a>
										</li>
									</ul>
								</div>
							</div>
						...
						<div style="position: relative">
							<div class="iseemore_detail fr-view shop_view_body" style="font-size: 12px;">
						...
						<div class="detail_review">
							...
							<div class="_review_wrap" style="padding-bottom: 30px;">
								<div class="i-font-70" style="font-size: 10px !important; margin-bottom: 8px !important;">
								Reviews were written by customers who bought this item.	
								</div>
								<a Onclick="" class="btn2 btn-primary2" style="margin-right: 3px; font-size: 10px;">Write a review</a> <!------- link X ------->
							</div>
							<div class="no_comment_box text-center">
								<div class="" style="color: rgba(0,0,0,0.4); margin: 30px;">No revies yet.</div>
							</div>
						...
						<div class="detail_review">
							...
							<div class="_review_wrap" style="padding-bottom: 30px;">
								...
								<div class="flexed">
									<a Onclick="" class="btn2 btn-primary2" style="margin-right: 3px; font-size: 10px; align-items: center;" >Ask a question</a> <!------- link X ------->
									<a Onclick="" class="btn1 btn-w2" style="width: 10%; font-size: 11px!important;">Support</a> <!------- link X ------->
								</div>
							</div>
							<div class="no_comment_box text-center">
								<div class="" style="color: rgba(0,0,0,0.4); margin: 30px;">No questions asked yet.</div>
							</div>
							<nav class="paging-block"></nav>
						</div>
					</div>
	...
	<!------------------ Section3 ------------------->
	<div class="inside container" style="padding-top: 60px; padding-bottom: 120px;">
