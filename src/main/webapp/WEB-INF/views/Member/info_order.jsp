...
<%-- <div align="center"
      ...
      <div align="center"
         style="width: 65%; height: auto; background-color: #f3f3f3; padding: 0px 25px;">
         <div align="left" style="float: left; width: 25%; margin-left: -200px; ">
         <%@ include file="../include/inside_header.jsp" %>   
         </div>
         
         <div
            style="width: 80%; height: auto; padding: 15px 0px 15px 200px; float: left;">
            <div
   ...
   <div
      ...
      <div style="width: 80%; height: auto%; padding: 50px 40px; float: left;">
         ...
         <center>
<div class="nosession" style="width: 100%; height: auto; padding:50px; color: #21212166; text-align: center ;"  >주문내역이 없습니다.</div>
            <div class="session"
               style="width: 80%; height: auto; color: #21212166; text-align: left; background-color: white; float: left;">
               <table>
                  <colgroup>
                     <col style="width: 40px;" />
                     <col style="width: 550px;" />
